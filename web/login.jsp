...
<html>
    ...
    <body class="text-center">
        <form id="loginForm" class="form-signin" action="login" method="POST">
            ...
            <input type="text" id="inputLogin" class="form-control" name="login" placeholder="User name" required autofocus>
            <label for="inputPassword" class="sr-only">Password</label>
            <input type="password" id="inputPassword" class="form-control" name="password" placeholder="Password" required>
            <input id="hidden" type="hidden" name="command" value="login">
